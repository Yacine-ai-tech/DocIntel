...
_RULES = (
    ...
    "a machine-readable decimal with a dot (e.g. European '1.234,56' -> 1234.56; strip "
    "thousands separators and currency symbols). Use ISO-4217 currency codes (USD, EUR, "
    "GBP, INR, JPY, ...). Dates as ISO YYYY-MM-DD. If a field is not present, use null. "
